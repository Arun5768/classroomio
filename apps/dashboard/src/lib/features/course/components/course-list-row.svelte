...
{#snippet rowContent()}
  <div
    class="grid w-full grid-cols-[5rem_minmax(0,1fr)] items-start gap-x-3 gap-y-2 @3xl:grid-cols-[var(--row-cols)]"
    style="--row-cols: {gridTemplateColumns}"
  >
    <!-- Banner -->
    <div
      class="ui:border-border bg-muted relative size-20 shrink-0 overflow-hidden rounded-md border @3xl:size-28"
      aria-hidden="true"
    >
